...
that 
% As shown in~\cite{drange2016kernelization}
...
the neighborhood complexity $|S^\phi(G/B)|$ is $\Oof(|B|^{1+\epsilon})$,
 ...
 These special cases have been proved earlier in \cite{drange2016kernelization} and in 
 \cite{eickmeyer2016neighborhood}, respectively, and in fact our proof relies on them.  
 These results where used 
 to obtain small kernels for the domination set problem~\cite{drange2016kernelization,eickmeyer2016neighborhood}.
...
for uniform quasi-wideness (\cref{thm:new-uqw}, and its extension to tuples~\cref{thm:uqw-tuples}), as well as the previous results on neighborhood complexity~\cite{eickmeyer2016neighborhood,drange2016kernelization} are the main ingredients of our main result,~\cref{thm:vc-density}.
