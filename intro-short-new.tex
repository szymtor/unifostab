...
\textcolor{red}{Classes of bounded expansion and} nowhere dense classes of graphs were introduced 
...
\textcolor{red}{Classes of bounded expansion~\cite{nevsetvril2008grad} 
...
\textcolor{red}{Especially} the concept of nowhere denseness
...
\textcolor{red}{Distance neighborhood complexity is a 
...
\textcolor{red}{It is not difficult to see that our result in fact yields new
characterizations
of nowhere dense graph classes and classes of bounded expansion 
which are closed under taking 
subgraphs. }
...
\textcolor{red}{\Cref{thm:vc-density} shows a strong new connection 
between first-order logic and the notions of bounded expansion
and nowhere denseness. This connection is particularly interesting for
the case of bounded expansion classes, as unlike for nowhere
dense graphs, we are not aware of formerly known characterizations of
these classes in terms of model theoretic notions.}
