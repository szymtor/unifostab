...
or, in the case $X$ is a set of variables, a \emph{valuation} in $X$.
For two tuples
...
% determines   the $(q,r)$-local type $(G,v|_Y)$ of the restriction of $v$ to $Y$.
   ...
   such that the sets $\{\im(u_1),\im(v_1)\}$ and $\{\im(u_2),\im(v_2)\}$
   are mutually $2r$-independent in $G$, for some $r$.
   Moreover, suppose that the $(q,r)$-local types of $(G,\im(u_1))$ and $(G,\im(u_2))$ are equal,
   and that the $(q,r)$-local types of $(G,\im(v_1))$ and $(G,\im(v_2))$ are equal.
   Then the $(q,r)$-local types of $(G,u_1\oplus v_1)$ and $(G,u_2\oplus v_2)$ are equal.
 \end{enumerate}
\end{proposition}
