...
\begin{lemma}\label{lem:gaifman}
 ...
 where $r=7^q$. \marginpar{this is wrong, correct is: for any $\tup a, \tup b$, if the two have the same local type, then they evaluate equally}
\end{lemma}
