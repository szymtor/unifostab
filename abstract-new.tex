...
Mendez~\cite{nevsetvril2010first,nevsetvril2011nowhere}.  Our results provide 
several upper bounds on various quantities
related to the logical structure of nowhere dense graph classes.
Firstly, we
...
classes of graphs.  Finally, we establish optimal bounds on the
