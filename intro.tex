...
Ziegler in~\cite{podewski1978stable}. In the following, we will give an
overview of some of the techniques that can be brought down from the uncountable
to the finite. 
...
2) In a combinatorial setting, finite or infinite, stability implies that for arbitrarily large sets, 
the number of types over a set is polynomial in the cardinality of the set.

3) Indiscernible sequences. 
