...
However, it is conceivable that the combination of 
...
and computes a hypothesis that with probability at least $1-\delta$
has an average error at most $\epsilon$. 

It is shown in \cite{chervonenkis1971theory,blumer1989learnability} 
that every concept class $\mathcal{C}$ is PAC-learnable with sample size
...
graph classes. Recent advances in this framework were also reported
in~\cite{grohe2017learning,grohe2017learning2}.
