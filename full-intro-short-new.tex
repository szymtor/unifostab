...
The combination of combinatorial and logical methods yields a powerful
...
\smallskip We now discuss the relevant background from logic and model
...
One of the concepts studied in the early years of stability theory is
...
Note that in principle, $S^\phi(\str A/B)$ may be equal to
...
As observed by Laskowski~\cite{laskowski1992vapnik}, VC-dimension can
...
\begin{theorem}[Sauer-Shelah Lemma,
  \cite{chervonenkis1971theory,sauer1972density,
    shelah1972combinatorial}]\label{thm:sauer-shelah}
...
Unlike~Theorem~\ref{thm:Shelah-stone-space}, this result is of
...
\cite{Bronnimann1995,matouvsek1998geometric,Matousek:2004:BVI:1005787.1005789,chervonenkis1971theory,blumer1989learnability}. %, see also \autoref{sec:ep}.
...
development of a linear kernel for the {\sc{$r$-Dominating Set}}
...
{\sc{$r$-Dominating Set}} problem.  We use this fact in our proof of
Theorem~\ref{thm:vc-density} as well.

\smallskip In our quest for constructive arguments, we give a new
...
% Note that in particular, Theorem~\ref{thm:new-stable} implies that
% every nowhere dense graph is stable, which was the main conclusion
% of the paper by Adler and Adler~\cite{adler2014interpreting}.
...
% This result is new in the context of nowhere dense graph classes,
% and is an important tool for the further results.
