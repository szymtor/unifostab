...
for distinct $\tup u, \tup v\in W^n$.\marginpar{this must be done differently when we deal with tuples}
...
that no tuple of $X$ contains an element of $S$. \marginpar{fix this.}
