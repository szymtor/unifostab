...
$$m_i=(t+1)^{\frac{\gamma^{r-i+1}-1}{\gamma-1}}\cdot m^{\gamma^{r-i}}.$$ 
Note that $m_r\geq m$ and $m_i=L(m_{i+1})$, for all $i\in \set{0,\ldots,r-1}$.

Suppose that $A$ is a set of vertices of $G$ such that $|A|\ge m_0=(t+1)^{\frac{\gamma^{r+1}-1}{\gamma-1}}\cdot m^{\gamma^{r}}$. 
...
as $N(m)=(t+1)^{\frac{\gamma^{r+1}-1}{\gamma-1}}\cdot m^{\gamma^{r}}$
